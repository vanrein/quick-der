...
#TODO# (re)pack mapped Python types in der_pack(): int, set ([]), []
...
class ASN1ConstructedType (ASN1Object):
	...
	"""The ASN.1 constructed types are SEQUENCE, SET and CHOICE.  Note
	   that SEQUENCE OF and SET OF are not considered constructed types.
	...
	def __init__ (self, bindata=[], ofs=0, structure=None):
		...
		for (k,v) in structure.items ():
			...
			if type (v) == int:
				...
				self._fields [k] = ASN1ConstructedType (
							bindata,
							ofs,
